...
public class CanvasUI16 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            answer16 = "8,5%";
            answer16Number = 8.5f * 0.02f;
        }

        if (SceneName == "2Modul")
        {
            answer16 = "2,0%";
            answer16Number = 2.0f * 0.02f;
        }
    ...
    {
        FindObjectOfType<MyAnswerCanvasAustralia>().setAnswer(answer16, answer16Number);
