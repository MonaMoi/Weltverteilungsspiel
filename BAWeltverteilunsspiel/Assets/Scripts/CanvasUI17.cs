...
public class CanvasUI17 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            answer17 = "23,7%";
            answer17Number = 23.7f * 0.02f;
        }

        if (SceneName == "2Modul")
        {
            answer17 = "19,2%";
            answer17Number = 19.2f * 0.02f;
        }
    }
    ...
    {
        FindObjectOfType<MyAnswerCanvasAustralia>().setAnswer(answer17, answer17Number);
