...
public class HighlightAustralia : MonoBehaviour
{
    ...
    private void GazeAt(bool ggazedAt)
    {
        ...
        {
            var materialsCopy = myRenderer.materials;
            materialsCopy[7] = highlightMaterial;
            myRenderer.materials = materialsCopy;
        }
        else
        {
    ...
    public void OnPointerClick()
    {
        ...
        CanvasShoworHideAustralia.SetActive(true);
    }
}
